  ...
  module RequestHandlers
    module Coupons
      ...
      def Coupons.included(klass)
        ...
        klass.add_handler 'post /v1/coupons/(.*)',   :update_coupon
      ...
      def update_coupon(route, method_url, params, headers)
        route =~ method_url
        assert_existence :coupon, $1, coupons[$1]
        allowed_params = params.slice(:metadata, :name, :currency_options)
        coupons[$1].merge!(allowed_params)
        coupons[$1]
      end
